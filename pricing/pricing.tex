...
\begin{figure}
  \begin{center}
    \includegraphics[width=5.5in]{plane}
  \end{center}
...
\begin{proof}
  ...
  \begin{figure}
    \begin{center}
      \begin{tabular}{ccc}
        \includegraphics[scale=0.9]{construction-a} & 
        \includegraphics[scale=0.9]{construction-b} & 
        \includegraphics[scale=0.9]{construction-c} \\
        The simplex $V$ & 
        $T$ intersects $T'$ & 
