...
$v$ are associated with the two regions obtained by removing a
...
Let $v_1,\ldots,v_k$ denote the path from $\lft(v)$ to the root of $T$
...
catalogues, $C_x(u)$ and $C_y(u)$, of the leaf $v$
with $q\in r(v)$ is
