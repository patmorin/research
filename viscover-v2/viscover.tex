...
polygon} of $p$ (w.r.t. $S$) is defined as (see \figref{fig:VizRegion}.a):
\[
...
\figref{fig:VizRegion}.b.  Unlike the visibility region of a point,
...
not intersect any (closed) segment in $S$. (see \figref{vg}.a).
...
$2m$ edges and at most $2m$ vertices to $\VG(S)$ as follows (see \figref{vg}.b):
...
This data structure is described in \secref{VizCountingAbs1}.
...
\seclabel{VizCountingAbs}

Although \corref{relative} offers a good approximation guarantee, the
...
As this example shows, the structure of \thmref{absolute-a} is quite
...
%and then discarding each element independently with probability
%$1-|C(S)|/(4n^2)$.
