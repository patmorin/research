...
$B_8(I)$ goes through $\N(p)$ (\figref{ef-two}.e).\footnote{Otherwise,
...
in their frontier. By \lemref{fourfour2} each image $I_i$, $1<i\leq p$
...
Thus applying \lemref{fourfour2} to $I_p$ results in an image
