...
% resolves the conflict between amsthm's and siamltex's proof environments
\let\proof\relax  
\let\endproof\relax
\usepackage{amsthm}
\usepackage{amsmath,graphicx,url,dbnsymb}
...
\thispagestyle{plain}
\markboth{P. BOSE, V.~DUJMOVI\'C, P. MORIN, AND M. SMID}{ROBUST GEOMETRIC SPANNERS}
...
\begin{figure}
  \begin{center}
    \includegraphics[width=.95\linewidth]{magnification}
  \end{center}
...
\begin{proof}
  ...
  \begin{figure}
    \begin{center}
      \includegraphics[width=.95\linewidth]{robust-1}
    \end{center}
    \caption{The graph $G'$}
    \figlabel{g-prime}
  \end{figure}
  ...
  \begin{figure}
    \begin{center}
      \includegraphics[width=.95\linewidth]{robust-2}
    \end{center}
