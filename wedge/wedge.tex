...
\begin{enumerate}
\item Change $f$ to $D$ throughout.
\item Expand paper summary and open problems.
\item Cite floodlights, wedge-separability, $(\alpha,k)$-sets, and 
	unoriented $\theta$-maxima.
\end{enumerate}
\end{minipage}
}
