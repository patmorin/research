...
by recursively applying \thmref{point-partition}.  The root of $T_S$
...
$t(v)$ that was obtained from \thmref{point-partition} and that generated
...
\begin{thm}[Matou\v{s}ek 1992]\thmlabel{point-partition-tree}
...
\begin{lem}\lemlabel{independent}
  ...
  \secref{data-structure}, let $V$ be an $i$-set of $T$, and let
