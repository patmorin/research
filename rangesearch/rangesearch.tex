...
The proof of \lemref{depth} is included in \appref{proof}.
...
immediately arise.  Refer to \appref{openproblems} for a list of
...
\appendix
\section{Proof of \lemref{depth}}
\applabel{proof}

\begin{proof}[Proof of \lemref{depth}]
