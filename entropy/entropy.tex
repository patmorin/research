...
The proof of \lemref{lower-bound} implies an important property of
...
$\mu_D(T') = X + O(X^{1/2})$.  However, \thmref{lower-bound} implies
that
\[
...
\mu_D(T')$.  Then, by \corref{triangles}, there is a triangulation of
...
of $G$.  Furthermore, by \corref{triangles}, there exists a linear
...
By \corref{triangles}, we may assume that each leaf of $T$
