...
\begin{proof}
  ...
  all points of the 1-grid.  What remains is the essential $p$-grid. (See \figref{grid} for a 2-dimensional illustration.)
...
%  Finally, 
  ...
  \[
    \sum_{i=1}^n \varphi(i)^2 \ge (9/\pi^4)n^3 + O(n\log^2 n) \ge (9/\pi^4)n^3 \ge n^3/11 \enspace .
  \]
  On the other hand, $\varphi(i) < i$, so
  \[  \sum_{i=1}^n \varphi(i)^2 < \sum_{i=1}^n i^2\le \sum_{i=1}^n n^2 = n^3 \enspace . \]
