...
\usepackage{graphicx,graphics,epsfig,amsfonts}
%\listfiles
...
\authornames{Devroye, Gudmundsson, and Morin}
\shorttitle{Maximum degree of Gabriel and Yao graphs}

\begin{document}
\title{On the Expected Maximum Degree \\ of Gabriel and Yao Graphs}

\authorone[McGill University]{Luc Devroye}
\addressone{School of Computer Science, McGill University, 3480 University Street, Montreal, Qu\'ebec, Canada, H3A 2A7}
\authortwo[NICTA]{Joachim Gudmundsson}
\addresstwo{NICTA, School of IT Building, J12 1, Cleveland Street, University of Sydney, NSW, Australia, 2006}
\authorthree[Carleton University]{Pat Morin}
\addressthree{School of Computer Science, Carleton University, 1125 Colonel By Drive, Ottawa, Ontario, Canada, K1S 5B6}
...
\keywords{Random geometric graphs; Gabriel graphs; Yao graphs; Maximum degree}

\ams{60D05}{68U05;52C99}
...
\begin{figure}[htbp]
\begin{center}\includegraphics{pearldef}\end{center}
