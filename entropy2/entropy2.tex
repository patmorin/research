...
Therefore, by \lemref{t-strong}, $w$ does not intersect $s$, since
...
entropy of $\Delta$ (\lemref{min-H-triangulation}).
...
most $c_i$ elements of each $\Delta_i$.  Thus, \lemref{pieces} is really
...
applying \lemref{pieces} with $c_{i}=18i^2$, we obtain:
\begin{equation} 
 H(\Delta) \le 
