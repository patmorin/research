...
treewidth.  A summary of these results is given in \tabref{volume-bounds}.
...
\begin{proof}[Proof of \lemref{2-layer}]
  ...
  length 2r centered at $u$; see \figref{skip-count}.   Therefore,
...
\lemref{2-layer}.  The drawing of $K_{\ell,\ell}$ we use is the graph $G$
...
By the proof of \thmref{4d-upper-bound} such a constant $c$ exists.
...
We end this section by remarking that the proof of \thmref{4d-counting}
