...
%\usepackage{fixacm}
\listfiles
\usepackage{graphicx,url,dbnsymb}
...
\begin{document}
\conferenceinfo{SoCG'13,} {June 17–20, 2013, Rio de Janeiro, Brazil.} 
\CopyrightYear{2013} 
\crdata{978-1-4503-2031-3/13/06} 
\clubpenalty=10000 
\widowpenalty = 10000
\maketitle
...
\category{F2.2}{Analysis of Algorithms and Problem Complexity}{Nonnumerical Algorithms and Problems}[Computations on discrete structures, Geometrical problems and computations]
...
\begin{figure}
  \begin{center}
    \includegraphics[width=\ScaleIfNeeded]{grid}
  \end{center}
...
\begin{figure}
  \begin{center}
    \includegraphics[width=\ScaleIfNeeded]{rft-problem}
  \end{center}
...
\begin{figure}
  \begin{center}
    \includegraphics[width=\ScaleIfNeeded]{magnification}
  \end{center}
...
$O(k^2)$-robust spanners can be constructed that have only $O(n\log n)$ edges.
...
In this section, we consider constructions of robust $t$-span-ners for
...
\begin{proof}
  ...
  \begin{figure}
    \begin{center}
      \includegraphics[width=\ScaleIfNeeded]{spanjump}
    \end{center}
...
\begin{proof} 
  ...
  \begin{figure}
    \begin{center}
      \includegraphics[width=\ScaleIfNeeded]{dumb-1}
    \end{center}
  ...
  \begin{figure}
    \begin{center}
      \includegraphics[width=\ScaleIfNeeded]{dumb-2}
    \end{center}
