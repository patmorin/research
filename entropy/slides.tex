...
\frame
{
   ...
   \begin{itemize}
    ...
    {\includegraphics[scale=.6]{ssplit-a}}
    \only<4>{\includegraphics[scale=.6]{ssplit-b}}%
    \only<5>{\includegraphics[scale=.6]{ssplit-c}}%
    \only<6>{\includegraphics[scale=.6]{ssplit-d}}%
    \only<7->{\includegraphics[scale=.6]{ssplit-e}}%
