...
%  less than $\n p^3$.  
  ...
  calculations that follow, it is helpful (though not strictly correct)
  to think of $\varphi(p)$ as $cp$ for some constant $0<c<1$.
  ...
  \end{equation}
  provided that $m\cdot\varphi(p)/\ell \ge 1$.  Since $\ell\le \n
  p^3$, the condition $m\cdot\varphi(p)/\ell \ge 1$ is satisified for
  $p\le\sqrt[3]{m/\n}$.
...
%  Finally, 
  ...
  \[
    (3/\pi^2)n^2 + O(n\log n) = \sum_{i=1}^n \varphi(i) \le \sqrt{\sum_{i} \varphi(i)^2}\cdot\sqrt{n} \enspace .
  \]
  Dividing by $\sqrt{n}$ and squaring, we obtain
  \[
    \sum_{i=1}^n \varphi(i)^2 \ge (9/\pi^4)n^3 + O(n^{3/2}\log^2 n) \ge n^3/11 \enspace .
  \]
