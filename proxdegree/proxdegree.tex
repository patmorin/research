...
\figref{yaodef}. Let $p$ be a positive integer, let $\theta=2\pi/p$, and
...
\[
  \begin{aligned}
    \frac{\EXP\{Y_1Y_2\}}{\EXP{Y_1}\EXP{Y_2}}
      ...
      & \le k^{4k} \left((4r+r^2) + \frac{(n-2)!}{(n-2-2k)!}\left(\frac{1}{nk^2}\right)^{2k}(1-16/n)^{n-2-2k}\right) \\
      & \le k^{4k} \left((4r+r^2) + n^{2k}\left(\frac{1}{nk^2}\right)^{2k}(1-16/n)^{n-2-2k}\right) \\
