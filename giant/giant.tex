...
\begin{abstract}
  ...
  few vertices from a robust spanner, this harms only a small number of
...
\begin{enumerate}
  ...
  are all in the same component and all vertices in this set having
...
The authors are grateful to the workshop organizers, Nicolas~Broutin,
Luc~Devroye, and G\'abor~Lugosi, the other participants, and the staff
