...
Average distance  & $O(n)^a$ $O(n\log n)$ & 
    \cite{bmm02,i99} & $O(n\log\log n)$ \\
Medoid (1-Median)  & $O(n)^a$ $O(n\log n)$ & 
    \cite{bmm02,i99} & $O(n\log\log n)$ \\
Discrete Fermat-Weber  & $O(n)^a$ $O(n\log n)$ & 
    \cite{bmm02,i99} & $O(n\log\log n)$ \\
Fermat-Weber  & $O(n)^b$ $O(n\log n)$ & 
    \cite{bmm02,i99} & $O(n)$ \\
Constrained Fermat-Weber  & $O(n)^b$ $O(n\log n)$ & 
    \cite{bmm02,i99} & $O(n)$ \\
Constrained OFL  & $O(n)^a$ $O(n\log n)$ & 
