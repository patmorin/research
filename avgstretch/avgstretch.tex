...
\thmref{upper-bound} is dedicated to showing that, in general, the disks
...
%  But then Property~4 of $k$-partitions implies that $\mu\in O(1)$.
  ...
  If $E'_{i_{j^*}}$ intersects $E_{i'}$, then (see \figref{jstar-a})
  \[
  ...
  $E_{i_{j^*+t+2\mu}}$ (see \figref{jstar-b}).  Then
  \[
