...
\usepackage{graphicx,graphics,url,amsmath}
\include{pat}
\listfiles
...
\category{I.3.5}{Computational Geometry and Object Modeling}{Algorithms}
\terms{Computational geometry, Point location, Minimum-entropy triangulation}
\acmformat{Collette, S., Dujmovi\'c, V., Iacono, J., Langerman, S., and Morin, P. 2011 Entropy, Triangulation, and Point Location in Planar Subdivisions}
...
\begin{figure}
  \begin{center}
    \begin{tabular}{cc}
      \includegraphics[scale=0.95]{ii-1} & 
      \includegraphics[scale=0.95]{ii-2} 
    \end{tabular}
  \end{center}
...
\begin{figure}
  \begin{center}
    \begin{tabular}{ccc}
      \includegraphics[scale=0.85]{pt-partition} & 
      \includegraphics[scale=0.85]{t-partition} &
      \includegraphics[scale=0.85]{t-partition-2} \\
      (a) & (b) & (c)
    \end{tabular}
  \end{center}
...
\begin{figure}
 \begin{center}\includegraphics[scale=0.85]{delta-tree}\end{center}
