...
The game ends after $n$ rounds and the players score is $\sum_{j=1}^n |P_i|$.
...
\noindent\includegraphics{figs/tiling.pdf}\\
\centerline{The smallest rectangle tiled by this polyomino (of order 138).}
