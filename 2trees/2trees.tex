...
\begin{figure}
\begin{center}\includegraphics[width=2in]{onlyif-b}\end{center}
\caption{The subgraph $G'$.}
\figlabel{onlyif-bb}
\end{figure}
\begin{figure}
\begin{center}\begin{tabular}{cccc}
\includegraphics[width=1.5in]{onlyif-b-1} &
\includegraphics[width=1.5in]{onlyif-b-2} &
\includegraphics[width=1.5in]{onlyif-b-3} &
\includegraphics[width=1.5in]{onlyif-b-4} \\
(a) & (b) & (c) & (d)
\end{tabular}\end{center}
\caption{The proof of \lemref{onlyif-b}.}
\end{figure}
...
\figref{onlyif-b}.X. Then by our assumption, $v$ and $w$ are degree-4
...
\figref{onlyif-b}.X. Vertices $v$, $w$ and $x$ have degree two
...
\figref{onlyif-b}.X. That however contradicts our assumption that there is
...
\figref{onlyif-b}.X, and consider, for instance, $G[V(G_1)\cup \{v,x\}]$. The
